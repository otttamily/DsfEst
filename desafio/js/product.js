...
function adicionarProduto() {
    ...
    let protudoFinal = produtos.concat(categorias)
    ...
    protudoFinal.push(novoProduto)
    localStorage.setItem("produtos", JSON.stringify(protudoFinal))
...
function carregarProdutos() {
    ...
    produtos.forEach((produto, index) => {
        ...
        row.innerHTML = `
            ...
            <td class="t4 br">R$${produto.preco}</td>
